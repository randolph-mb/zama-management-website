...
export default function StorySection() {
    return (
        <section className="bg-[var(--foreground)] py-12 sm:py-16 md:py-24 px-4 sm:px-6">
            <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 md:gap-12 items-center">
                {/* Image */}
                <div className="w-full h-auto relative aspect-[3/4] rounded-lg overflow-hidden">
                    <Image
                        src={ASSETS.IMAGES.BRIDGE_BUILDER}
                        alt="Brückenbauer"
                        fill
                ...
                {/* Text Content */}
                <div className="bg-[var(--foreground)] p-4 sm:p-6 md:p-12">
                    <h2 className="text-[var(--color-text-white)] text-3xl sm:text-4xl md:text-5xl mb-6 sm:mb-8 font-bold">
                        Brückenbauer
                    </h2>
                    <div className="text-[var(--color-text-white)] text-base md:text-lg leading-relaxed space-y-4 sm:space-y-5">
                        <p>
